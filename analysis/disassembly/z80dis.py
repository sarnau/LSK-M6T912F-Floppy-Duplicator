...
DATA_REGIONS = [
    ...
    (0x4B29, 0x4B89, 'fmt_geom_recs'),    # 8x 12-byte format geometry records (sectors/track per zone)
...
SYMBOLS.update({
    ...
    0x316C:'serial_cyl',
    0x316D:'serial_head',
    0x316E:'serial_sector',
    0x316F:'serial_offset',
    0x3170:'serial_pos',
    0x3172:'serial_flag',
    0x3173:'serial_addr',
    0x3175:'serial_ptr',
...
COMMENTS.update({
    ...
    0x3168:'serialization: current serial number (word)',
    0x316A:'serialization: increment added per disk (word)',
    0x316C:'serialization: target cylinder for the stamp',
    0x316D:'serialization: target head for the stamp',
    0x316E:'serialization: target sector for the stamp',
    0x316F:'serialization: byte offset within the sector (init 1)',
    0x3170:'serialization: computed write position (word)',
    0x3172:'serialization: sub-flag / bit-verify toggle',
...
COMMENTS.update({
    ...
    0x4B29: '8x 12-byte format geometry records (sectors/track per zone); accessed in 24-byte (2-record) format pairs',
