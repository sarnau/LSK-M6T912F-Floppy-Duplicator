...
| `analysis/disassembly/full-disassembly.lst` | Generated, fully-labeled listing (`0x0000–0x52FF`) |
...
python3 z80dis.py "../../LSK M6T912F D1:97.bin" 0x0000 0x5300 > full-disassembly.lst
```
